...
<body>
  <div class="container text-center" style="width: 70%">
    <p><h1 class = "text-primary">GESTION DE PROJET</h1></p>
  ...
  <br/>
  <img src="images/Planning.png" alt="LDiscord de mi-projet" width=800>
  <br/><br/><br/>
  <p>
